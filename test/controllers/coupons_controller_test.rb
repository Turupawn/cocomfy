...
class CouponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post coupons_url, params: { coupon: { discount: @coupon.discount, name: @coupon.name } }
    end
  ...
  test "should update coupon" do
    patch coupon_url(@coupon), params: { coupon: { discount: @coupon.discount, name: @coupon.name } }
